...
public class ScrabbleScoreTests
{
    ...
    [Fact]
    public void One_double_letter_and_one_triple_word_score_and_use_all_tiles()
    {
    ...
    [Fact]
    public void One_blank_letter_score()
    {
        Assert.Equal(7, ScrabbleScore.Score("hello", blankLetters: ['l']));
    }

    [Fact]
    public void Two_blank_letters_score()
    {
        Assert.Equal(3, ScrabbleScore.Score("hello", blankLetters: ['h', 'l']));
    }

    [Fact]
    public void One_blank_letter_one_triple_letter_score()
    {
        Assert.Equal(15, ScrabbleScore.Score("hello", blankLetters: ['l'], tripleLetters: ['h']));
    }

    [Fact]
    public void One_blank_letter_one_double_word_score()
    {
        Assert.Equal(14, ScrabbleScore.Score("hello", blankLetters: ['l'], doubleWordCount: 1));
    }

    [Fact]
    public void One_blank_letter_one_double_letter_score_and_use_all_tiles()
    {
        Assert.Equal(61, ScrabbleScore.Score(
            "hello",
            blankLetters: ['l'],
            doubleLetters: ['h'],
            allTilesUsed: true));
