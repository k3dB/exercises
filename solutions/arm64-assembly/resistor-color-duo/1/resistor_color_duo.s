...
value:
    ...
    sub   sp, sp, #8            // Push ones place color onto stack
    str   x2, [sp]
    ...
    str   x2, [sp]              // Push tens value in place of ones place color
    ...
    ldr   x1, [sp]              // Pop tens value back from stack
    add   sp, sp, #8

    add   x0, x0, x1            // Add second index to ten times first index
