...
stringify_currency:
    ...
    lea   rsi, [rax + 4 * rsi]  ; Apply offset for source
    movsd                       ; All values are 4 bytes
    ret
...
exchange_rate:
    ...
    movsd xmm0, qword [rdx + 8 * rsi] ; Foreign
    movsd xmm1, qword [rdx + 8 * rdi] ; Domestic
...
get_value_of_bills:
    ...
    movzx rax, si         ; Zero extend the 16-bit number of bills
    mul   rdi             ; Multiply the two inputs
    ret
...
exchangeable_value:
    ...
    movzx    edi, dil     ; Zero extend 8-bit spread
