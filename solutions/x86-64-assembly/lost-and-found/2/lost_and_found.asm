...
create_item_entry:
    ...
    lea   rsi, [rsp + 8]         ; Start for source of categories
    add   rdi, 40                ; Start for destination of categories
    mov   rcx, r9                ; Number of categories to store
    rep   movsq                  ; Store all categories
    ret
