...
.next_score:
    ...
    cmovg eax, edx        ; If so, replace highest with current score
    jmp   .next_score
...
personal_top_three:
    ...
    cmovg rax, rcx                  ; Otherwise, limit to three highest
